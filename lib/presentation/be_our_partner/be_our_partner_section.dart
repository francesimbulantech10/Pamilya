        ...
        child: Column(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    AutoSizeInterText(
                      ...
                      fontSize: 50,
                      color:
                          Color(0xFFED2080), // Changed to white for visibility
                      fw: FontWeight.bold,
                      fontFamily: "Poppinsbold",
                      maxLines: 2,
                    ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Stack(children: [
                        ...
                        const Padding(
                          padding:
                              EdgeInsets.only(left: 60, top: 27, right: 20),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
              ...
              Column(
                ...
                children: [
                  Stack(children: [
                    Image.asset('assets/connect_withus1.png',
                        width: size.width),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: AutoSizeInterText(
                                          text:
                                              'Low commission or transaction fee',
                                          fontSize: 14,
                                          color: Colors
                                              .black, // Changed to white for visibility
                                          fw: FontWeight.normal,
                    ...
                    SizedBox(
                      child: TextButton(
                        ...
                        child: const Text(
                          ...
                          style: TextStyle(
                            color:
                                Colors.white, // Set text color for visibility
                            fontSize: 16,
                          ),
                        ),
                      ),
